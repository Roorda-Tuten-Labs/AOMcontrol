function [x1,x2,y1,y2,Error]=TrackPupilV2020_ExtQuarter_Reflection3(A,Graphic)
...
if isempty(idx255_v), Error=-1; return; end
...
if sum(ver)==0, Error=-2; return; end
